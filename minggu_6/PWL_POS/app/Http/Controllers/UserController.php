...
class UserController extends Controller
{
    public function index() { // menampilkan halaman awal user
        ...
        $activeMenu = 'user'; // sest menu yang sedang aktif
    ...
    public function list(Request $request) { // ambil data user dalam bentuk json untuk datatables
    ...
    public function create() { // menampilkan halaman form tambah user
        $breadcrumb = (object) [
            'title' => 'Tambah User',
    ...
    public function show(String $id) { // menampilkan detail user
    ...
    public function edit(string $id) { // menampilkan halaman form edit user
    ...
    public function destroy(string $id) { // menghapus data user
