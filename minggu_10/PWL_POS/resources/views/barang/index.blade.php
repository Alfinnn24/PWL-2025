...
<div class="card">
    <div class="card-header">
        ...
        <button onclick="modalAction('{{ url('/barang/import') }}')" class="btn btn-warning">Import Barang</button>
            <a href="{{ url('/barang/export_excel') }}" class="btn btn-info"><i class="fa fa-file-excel"></i> Export Barang</a>
                <a href="{{ url('/barang/export_pdf') }}" class="btn btn-danger" target="blank"><i class="fa fa-file-pdf"></i> Export Barang PDF</a>
